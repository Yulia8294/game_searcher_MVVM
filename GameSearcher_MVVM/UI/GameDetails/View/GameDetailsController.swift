...
class GameDetailsController: UIViewController {
    ...
    private var similarGamesDataSource: SimilarGamesDataSource!
    private var screenshotsDataSource:  ScreenshotsDataSource!
...
//MARK: - Lifecycle
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        similarGamesDataSource = SimilarGamesDataSource(similarCollectionView, presentingVC: self)
        screenshotsDataSource = ScreenshotsDataSource(screenshotsCollectionView, collectionPageControl)
...
//MARK: - ViewModel input
    ...
    private func onSimilarGamesChanged(_ games: [GameItemViewModel]) {
        similarGamesDataSource.games = games
    }
